...
switch (command) {
    ...
    break
        case 'daftar':
                ...
                if (umurUser > 50) return replygcxeon(`your age is too  old maximum 50 years`)
               ...
               thumb = fs.readFileSync("./thumbnail/regisnya.jpg")
                veri = m.sender
                if (!m.isGroup) {
		...
		break   
        case 'paptt':
            if (!isPrem && !isOwner) return replygcxeon(mess.prem)
...
case "backup":
        {
          if (!isOwner) replygcxeon("Khusus Owner Anj!!!"); 
...
case 'idgc': {
 ...
 if (!isOwner) return m.replygcxeon(`Khusus Owner`)
...
> _penyedia Module_
> _DGXeon (sc ori)_
> _My Self (Saya Sendiri rizal-dev❄️)_
> _Hyuu offc_
> _BGDARWIN_
> _HenzzXD_`
sendKyuuMessage(from, { 
...
case 'bott': case 'bot?': case 'list': case 'menu': case 'bot': case '?': {
            ...
            xeonezy = `  *ʜᴀʟᴏ ᴋᴀᴋ , @${sender.split("@")[0]} 👋.*
...
𖣂 *I N F O - B O T*
   ...
   ❄️ *ᴠᴇʀꜱɪᴏɴ* : *6*
   ❄️ *ʙᴀɪʟᴇyꜱ* : *@adiwashing/baileys*
   ❄️ *ᴏᴡɴᴇʀ* : *${global.namaku}*
   
𖣂 *I N F O* 
   ❄️ *ᴏᴡɴᴇʀ* = For Owner
   ❄️ *ɢʀᴏᴜᴘ* = For Group
   ❄️ *ғʀᴇᴇ* = For Free User
   ❄️ *ᴘʀᴇᴍɪᴜᴍ* = For Premium User
...
┌ ◦ ${prefix}antilinkgc  
々 ${prefix}antiwame  
々 ${prefix}antilinkall  
々 ${prefix}antilinktiktok 
々 ${prefix}antilinkfb  
々 ${prefix}antilinktwitter  
々 ${prefix}antilinkig 
々 ${prefix}antilinktg 
々 ${prefix}antilinkytvid  
々 ${prefix}antilinkytch  
々 ${prefix}antivirus  
々 ${prefix}antitoxic  
々 ${prefix}antilink  
└ ◦ ${prefix}antiwame  
...
々 ${prefix}closetime  
々 ${prefix}resetlink  
々 ${prefix}autostickerpc 
々 ${prefix}nsfw 
└ ◦ ${prefix}react  

*𖣂 R A N D O M  V I D E O ッ*
...
*𖣂 T E X T P R O  M A K E R ッ*

┌ ◦ ${prefix}candy  
々 ${prefix}christmas 
々 ${prefix}3dchristmas  
々 ${prefix}sparklechristmas 
々 ${prefix}deepsea  
々 ${prefix}scifi  
々 ${prefix}rainbow  
々 ${prefix}waterpipe  
...
々 ${prefix}neonlight  
々 ${prefix}glitch  
々 ${prefix}harrypotter  
々 ${prefix}brokenglass  
々 ${prefix}papercut 
々 ${prefix}watercolor 
々 ${prefix}multicolor 
々 ${prefix}neondevil  
々 ${prefix}underwater  
々 ${prefix}graffitibike  
々 ${prefix}snow  
々 ${prefix}cloud  
々 ${prefix}honey  
々 ${prefix}ice  
...
*𖣂 E P H O T O  M A K E R ッ*

々 ${prefix}glitchtext  *ᴘʀᴇᴍɪᴜᴍ*
々 ${prefix}writetext 
...
┌ ◦ ${prefix}pushcontact  *ᴏᴡɴᴇʀ*
々 ${prefix}pushcontactv2  *ᴏᴡɴᴇʀ*
々 ${prefix}savecontact  *ᴏᴡɴᴇʀ*
々 ${prefix}pushmember  *ᴏᴡɴᴇʀ*
々 ${prefix}idgc  *ᴏᴡɴᴇʀ*
└ ◦ ${prefix}jpm  *ᴏᴡɴᴇʀ*
...
me = m.sender
teks = `buy di  @${global.ownernumber}`
sendKyuuMessage(from, { 
text: teks,
mentions:[sender],
contextInfo:{
...
if (!isOwner) return replygcxeon('*khusus Premium*')
...
break
    case 'toptv':{
if (!isOwner) return replygcxeon('*Khusus Owner*')
